    ...
    def update(self):
        ...
        for point in points:
            if point.x == self.x and point.y == self.y:
                if point.color != [255, 255, 255] and point.color != [0, 0, 0]:
                    #print(point.color, point.color != [255, 255, 255])
                    self.crash()
                    return
                if point.color == [255, 255, 255]:
                    for p in points:
...
class AIBike(Snake):
    ...
    def get_move(self):
        ...
        if len(moves) > 0:
            ...
            b = True
            try:
                if snake.x > self.x and moves.index("right") > -1:
                    primary.append("right")
                    b = False
                elif snake.x < self.x and moves.index("left") > -1:
                    primary.append("left")
                    b = False
                if snake.y > self.y and moves.index("down") > -1:
                    primary.append("down")
                    b = False
                elif snake.y < self.y and moves.index("up") > -1:
                    primary.append("up")
                    b = False
            except ValueError:
                 x = 0
